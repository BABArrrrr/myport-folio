...
export const PROJECTS = [
  ...
  },
  {
    ...
    image: project2,
    description:
    "I've created the frontend of this website using for my practice. This website is use for online registration for patient ",
    technologies: ["HTML", "CSS", "JavaScript", "Bootstrap", ],
